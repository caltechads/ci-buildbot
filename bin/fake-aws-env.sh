...
export MAVEN_OPTS=-Dmaven.wagon.httpconnectionManager.maxPerRoute=2
...
export CODEBUILD_BUILD_ARN=arn:aws:codebuild:us-west-2:467892444047:build/terraform-caltech-commons-DockerImageBuild:87bd7955-6c38-4554-b353-ac67880e1347
export AWS_CONTAINER_CREDENTIALS_RELATIVE_URI=/v2/credentials/e5f23b9f-c72e-4384-9ba1-37d08aa052b7
export CODEBUILD_START_TIME=1591134176.420613
export CODEBUILD_INITIATOR=codepipeline/terraform-caltech-commons
